...
#### 1. Auto-Running Hooks Were Problematic
The build and test hooks that fire on every edit caused friction during development. **Suggestion**: Make hooks opt-in or provide a clear way to disable them when they get in the way.

#### 2. Plugin/Skill Discovery Is Too Hidden
...
#### 3. Browser Testing Should Be Pre-Configured
...
#### 4. Playwright Cannot Access the Wallet — Chrome Remote Debugging Needed
...
#### 5. Chrome Setup Was Painful (Arc Incompatible, Profile Issues)
...
#### 6. Wallet Connection Didn't Work Out of the Box
...
#### 7. Counter Contract Leftovers in the Template
